namespace Sharptimizer.Benchmarks.CEC
{
    ...
    public class F7 : CECBenchmark
    {
        ...
        /// <returns></returns>
        public F7(string name = "F7", string year = "2013", List<string> auxiliaryData = null, int dims = 1000,
                                                                                                                    ...
                                                                                                                    separable)
        {
            ...
            W = new double[] { 679.9025, 0.9321, 2122.8501, 0.5060, 434.5961, 33389.6244, 2.5692 };
        }
        ...
        /// <summary>
        /// Executes the 7-separable, 1-separable Shifted Schwefel's benchmarking function.
        /// </summary>
